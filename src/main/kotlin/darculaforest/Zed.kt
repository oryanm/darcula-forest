...
data class ZedSyntax(
    ...
    val number: ZedToken,
    @SerialName("operator")                 val operatorTok: ZedToken,
    ...
    val title: ZedToken,
    @SerialName("type")                     val typeScope: ZedToken,
        ...
        ZedThemeVariant(
            ...
            style = ZedStyle(
                ...
                syntax = ZedSyntax(
                    ...
                    constructorTok        = token(functionDecl),
                    embedded              = token(fg),
                    emphasis              = token(keyword, fontStyle = "italic"),
                    emphasisStrong        = token(keyword, fontWeight = 700),
                    enumScope             = token(constantField),
                    function              = token(functionDecl),
                    hint                  = token(textMuted),
                    ...
                    predictive            = token(textPlaceholder, fontStyle = "italic"),
                    ...
                    selectorPseudo        = token(functionDecl),
                    string                = token(string),
                    ...
                    tag                   = token(keyword),
                    textLiteral           = token(string),
                    title                 = token(functionDecl, fontWeight = 700),
                    typeScope             = token(fg),
                    variable              = token(fg),
